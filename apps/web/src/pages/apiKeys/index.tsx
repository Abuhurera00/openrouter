...
import { useCreateApiKeyMutation, useDeleteApiKeyMutation, useToggleApiKeyMutation } from "@/utils/api/apiKeys/mutation";
...
export default function ApiKeys() {
    ...
    const createMutation = useCreateApiKeyMutation({
        onSuccess: (data: ApiResponse) => {
            setNewlyCreatedKey(data.data?.apiKey ?? null);
                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody>
                                {apiKeys.map((key: ApiKeyData) => (
                                    <tr key={key._id} className="border-b border-border/30 last:border-0 group">
